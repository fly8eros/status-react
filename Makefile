...
run-android: ##@run Build Android APK and start it on the device
	$(shell sed -i '187c\        applicationId "im.status.ethereum"' $(PWD)/android/app/build.gradle)
	$(shell sed -i '188c // applicationId "fund.eros.xos"' $(PWD)/android/app/build.gradle)
