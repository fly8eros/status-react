...
(defn list-header [empty?]
  [react/view
   [react/touchable-highlight {:on-press #(re-frame/dispatch [:browser.ui/open-url (str "https://dapps.eros.fund/" (.getTime (js/Date.)))])}
    [react/view (styles/dapp-store-container)
     ...
     [react/text {:style {:color colors/blue :font-size 13 :line-height 22}} "https://dapps.eros.fund ->"]]]
   (when-not empty?
