...
(reg-root-key-sub :dapps-networks/current-network :dapps-networks/current-network)
(reg-root-key-sub :dapps-networks/networks :dapps-networks/networks)
(reg-root-key-sub :dapps-networks/network-changed? :dapps-networks/network-changed?)
